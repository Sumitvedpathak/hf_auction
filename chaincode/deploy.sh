...
sleep 1
echo 'Bidding'
peer chaincode invoke ${orderer} -C mychannel -n ${CHAINCODE}${VERSION} ${peer_org1} ${peer_org2} -c '{"function":"bid","Args":["1","1","55"]}'
peer chaincode invoke ${orderer} -C mychannel -n ${CHAINCODE}${VERSION} ${peer_org1} ${peer_org2} -c '{"function":"bid","Args":["2","1","65"]}'
peer chaincode invoke ${orderer} -C mychannel -n ${CHAINCODE}${VERSION} ${peer_org1} ${peer_org2} -c '{"function":"bid","Args":["3","1","70"]}'
